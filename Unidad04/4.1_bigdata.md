...
En el artículo se han revisado 117 artículos que aplican big data en 8 dominios según Bahga and Madisetti [65] 
...
Transporte:   Es una actividad clave. Ayuda en la planeación de rutas y desarrolla las aplicaciones para vigilancia, emergencia, control de tráfico, detección de anomalías, predicción de tráfico. Minimización de contaminantes. 
 ...
 **MapReduce** es un metodo bien aceptado para hacer computo paralelo y recuperar datos de un almacenamiento distribuido.
